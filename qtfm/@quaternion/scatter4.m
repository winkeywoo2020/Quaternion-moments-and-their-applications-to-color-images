...
set(get(p1, 'XLabel'), 'String', '1');
set(get(p1, 'YLabel'), 'String', 'I');
set(get(p2, 'XLabel'), 'String', '1');
set(get(p2, 'YLabel'), 'String', 'J');
set(get(p3, 'XLabel'), 'String', '1');
set(get(p3, 'YLabel'), 'String', 'K');
set(get(p4, 'XLabel'), 'String', 'I');
set(get(p4, 'YLabel'), 'String', 'J');
set(get(p5, 'XLabel'), 'String', 'J');
set(get(p5, 'YLabel'), 'String', 'K');
set(get(p6, 'XLabel'), 'String', 'K');
set(get(p6, 'YLabel'), 'String', 'I');

end

% $Id: scatter4.m,v 1.2 2011/07/23 14:21:16 sangwine Exp $
